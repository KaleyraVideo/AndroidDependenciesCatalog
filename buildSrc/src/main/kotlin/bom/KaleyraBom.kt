...
object KaleyraBom: Bom {
    ...
    init {
        ...
        libraries.apply {
            ...
            add(Library("kaleyraVideoExtensionNoiseFilterLazyModel", "com.kaleyra", "video-extension-noise-filter-lazymodel", Version("kaleyraVideoExtensionNoiseFilter", kaleyraVideoExtensionsVersion)))
        }
    }
}