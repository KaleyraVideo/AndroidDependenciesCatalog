...
object KaleyraDependencies : Dependencies {
    ...
    init {
        ...
        versions.apply {
            ...
            // bandyer
            val kaleyraVideoCoreAvVersion = Version("kaleyraVideoCoreAvVersion", "2.2.0").apply { add(this) }
            ...
            val kaleyraVideoVersion = Version("kaleyraVideoVersion", "1.3.0").apply { add(this) }
