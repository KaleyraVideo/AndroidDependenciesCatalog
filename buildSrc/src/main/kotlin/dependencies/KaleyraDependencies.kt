...
object KaleyraDependencies : Dependencies {
    ...
    init {
        ...
        versions.apply {
            ...
            val kaleyraCommunicationCenterVersion = Version("kaleyraCommunicationCenterVersion", "14.1.0").apply { add(this) }
            ...
            val kaleyraVideoVersion = Version("kaleyraVideoVersion", "1.0.0-rc07").apply { add(this) }
