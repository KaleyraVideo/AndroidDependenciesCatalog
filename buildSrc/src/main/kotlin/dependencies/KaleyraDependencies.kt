...
object KaleyraDependencies : Dependencies {
    ...
    init {
        ...
        versions.apply {
            ...
            // bandyer
            val kaleyraVideoCoreAvVersion = Version("kaleyraVideoCoreAvVersion", "2.3.2").apply { add(this) }
            val bandyerFirecrasherVersion = Version("bandyerFirecrasherVersion", "1.1.1").apply { add(this) }
            val kaleyraCommunicationCenterVersion = Version("kaleyraCommunicationCenterVersion", "15.0.1").apply { add(this) }
            ...
            val kaleyraVideoVersion = Version("kaleyraVideoVersion", "1.4.0").apply { add(this) }
