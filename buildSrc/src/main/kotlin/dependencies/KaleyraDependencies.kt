...
object KaleyraDependencies : Dependencies {
    ...
    init {
        ...
        versions.apply {
            ...
            val kaleyraVideoVersion = Version("kaleyraVideoVersion", "1.5.0").apply { add(this) }
            ...
            val kaleyraAndroidDeepFilterNetVersion = Version("kaleyraAndroidDeepFilterNetVersion", "0.0.7").apply { add(this) }
