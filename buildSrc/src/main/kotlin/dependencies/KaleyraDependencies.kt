...
object KaleyraDependencies : Dependencies {
    ...
    init {
        ...
        versions.apply {
            ...
            // bandyer
            val kaleyraVideoCoreAvVersion = Version("kaleyraVideoCoreAvVersion", "2.3.5").apply { add(this) }
            val bandyerFirecrasherVersion = Version("bandyerFirecrasherVersion", "1.1.1").apply { add(this) }
            val kaleyraCommunicationCenterVersion = Version("kaleyraCommunicationCenterVersion", "15.0.3").apply { add(this) }
            ...
            val kaleyraVideoVersion = Version("kaleyraVideoVersion", "1.5.1").apply { add(this) }
            val kaleyraVideoUtilsVersion = Version("kaleyraVideoUtilsVersion", "2.1.0").apply { add(this) }
            ...
            val kaleyraMaterialColorUtilitiesVersion = Version("kaleyraMaterialColorUtilitiesVersion", "2025.07.00").apply { add(this) }
            val kaleyraAndroidDeepFilterNetVersion = Version("kaleyraAndroidDeepFilterNetVersion", "0.0.8").apply { add(this) }
            ...
            libraries.apply {
                ...
                add(Library("kaleyraAndroidDeepFilterNetLazyModel", "io.github.kaleyravideo", "android-deepfilternet-lazymodel", kaleyraAndroidDeepFilterNetVersion))
            }
        }
