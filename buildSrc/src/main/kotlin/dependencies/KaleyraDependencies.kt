...
object KaleyraDependencies : Dependencies {
    ...
    init {
        ...
        versions.apply {
            ...
            // bandyer
            val kaleyraVideoCoreAvVersion = Version("kaleyraVideoCoreAvVersion", "2.3.1").apply { add(this) }
            ...
            val kaleyraAndroidDeepFilterNetVersion = Version("kaleyraAndroidDeepFilterNetVersion", "0.0.6").apply { add(this) }
